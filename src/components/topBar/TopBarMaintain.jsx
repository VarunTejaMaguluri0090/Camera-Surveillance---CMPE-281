...
export default function TopBarMaintain(props) {
  ...
  return (
    ...
    // Creating a topbar wraapper - with 2 parts - left and right
      ...
      {localStorage.getItem('userToken') ? (
        <div>
          <h1 className="heading-main">Welcome, Maintainance Team!</h1>
        ...
        <h1 className="heading-main">You are not logged in.</h1>
            ...
            <span className="logo">Maintainance Team Dashboard</span>
            </div>
